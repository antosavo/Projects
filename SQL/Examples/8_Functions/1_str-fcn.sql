...
INSERT INTO party (dept, name) VALUES
("accounts", "Graham Miller"),
("sales", "Gary Miller"),
("production", "Graham Wallace");

-- get 3-letter substrings from the dept column
SELECT SUBSTRING(dept, 1, 3) FROM party; -- SUBSTRING(string, position, length)
